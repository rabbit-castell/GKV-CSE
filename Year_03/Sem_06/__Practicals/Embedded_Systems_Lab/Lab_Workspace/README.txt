...
- Experiments (Clean): The final "ready-to-use" files. Includes code, 
  documentation, and Proteus simulations that work out of the box.
- Experiments (Dump): The raw Keil project files. Use these if you 
  need to modify or recompile the code yourself.
